...
In this lab section, you will query your **FoodCollection**. You must complete [Lab 02 - Load Data Into Cosmos DB with ADF](https://github.com/CSALabsAutomation/azure-cosmosdb-lab/blob/main/steps/02_load-data-into-cosmos-db-with-adf/documentation.md) before starting this lab.
